    ...
    const PAYMENT_MODE_OPTIONS = [
      { value: "non_periodic", label: "Non-recurring" },
      { value: "periodic", label: "Recurring (Retainer)" },
    ];
    ...
    const lawyerLabel = (lawyer) => {
      ...
      return (
        compact([
          ...
          typeLabel && typeLabel !== "Luật sư" ? `(${typeLabel})` : "",
    ...
    const cleanPaymentScheduleRows = (rows = [], baseAmount = 0) => {
      const cleaned = rows
        .map((row, index) => {
          ...
          const defaultInstallment = `Installment ${index + 1}`;
    ...
    const ManualContractServicesSection = ({
      ...
      const columns = `minmax(260px, 1.3fr) minmax(200px, 0.9fr) minmax(190px, 0.85fr) 98px minmax(165px, 0.75fr)${actionColumn}`;
              ...
              return React.createElement(
                  ...
                  isCustom
                    ? React.createElement(
                        ...
                        isNameAlreadyInCatalog &&
                          React.createElement("div", { style: { fontSize: 11, color: C.sub, marginTop: 3 } }, "Already in the standardized catalog"),
                      )
                ...
                React.createElement(
                  ...
                  isCustom
                    ...
                    : React.createElement("span", { style: { color: C.text, fontSize: 12.5, fontFamily: "monospace" } }, formatMoney(item.basePrice || 0, selectedComboCurrency)),
                ),
                React.createElement(
                  "td",
                  { style: comboTd() },
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement("th", { style: modalThStyle() }, "Combo"),
                  React.createElement("th", { style: modalThStyle({ width: 170, textAlign: "right" }) }, "Combo Price"),
                  React.createElement("th", { style: modalThStyle({ width: 100, textAlign: "center" }) }, "Services"),
                  ...
                  : filteredCombos.map((c, i) => {
                      ...
                      return React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement("div", null, c.comboName || `Package #${c.id}`),
                          c.serviceComboType &&
                            React.createElement(
                              "span",
                              {
        ...
        React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Field,
                    { label: "Combo Name", required: true },
                    React.createElement(TextInput, {
                      value: comboName,
                      onChange: (value) => {
                        setComboName(value);
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Field,
                    { label: "Combo Type", hint: "optional" },
                    React.createElement(TextInput, {
                      value: comboType,
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Field,
                    { label: "Combo Subtotal", required: true },
                    React.createElement(
                      "div",
                    ...
                    comboItems.length > 0 &&
                      (() => {
                        ...
                        return React.createElement(
                          ...
                          delta < 0 &&
                            React.createElement("span", { style: { color: "#52c41a", fontWeight: 600 } }, `Giảm ${formatMoney(-delta, selectedComboCurrency)}`),
                          delta > 0 &&
                            React.createElement("span", { style: { color: "#faad14", fontWeight: 600 } }, `Tăng ${formatMoney(delta, selectedComboCurrency)}`),
                        );
                      })(),
                  ),
                ),
              ...
              React.createElement(
                ...
                React.createElement("span", { style: { fontSize: 13, fontWeight: 700, color: C.text, fontFamily: FONT } }, `Services in package (${comboItems.length})`),
                React.createElement(
                  "div",
          ...
          React.createElement(
            ...
            React.createElement(
              "span",
              null,
              "Also save this combo to the shared catalog (created only if you finish creating this contract). All custom services in it are saved too — services already in the catalog are simply reused.",
            ),
          ),
          React.createElement(
            "div",
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          "span",
                          null,
                          "Also save to the shared catalog (created only if you finish creating this contract).",
                        ),
                      ),
                      duplicateNewService &&
                        React.createElement(
            ...
            React.createElement(
              ...
              showAddRow &&
                (AntButton
                  ? React.createElement(
                      AntButton,
                      { type: "dashed", onClick: () => openPicker(NEW_ROW_SENTINEL) },
                      PlusIcon,
                      " New service",
                    )
                  : React.createElement(
                      ...
                      {
                        type: "button",
                        onClick: () => openPicker(NEW_ROW_SENTINEL),
                        style: {
                          border: `1px dashed ${C.primary}`,
                          background: "#fff",
                          color: C.primary,
            ...
            React.createElement(
              ...
              rows.length
                ...
                : React.createElement(
                    ...
                    'No services added. Click "New service" to add contract services.',
                  ),
              React.createElement(
                "div",
                {
    ...
    const PaymentScheduleSection = ({
      ...
      const columns =
        "minmax(130px, 0.7fr) minmax(200px, 0.9fr) minmax(100px, 0.5fr) minmax(260px, 1.6fr) minmax(180px, 0.85fr) minmax(140px, 0.7fr) 52px";
      const headerStyle = {
        padding: "11px 14px",
        background: "#fbfcfd",
        color: C.sub,
      ...
      // No longer its own top-level Section (border-top + title) — merged
      // into the same "Services & Payment" block as ManualContractServicesSection
      // (2026-09-21), so a lawyer can reference which services exist while
      // tagging installments without scrolling between 2 separate Sections.
      // A lighter sub-heading (vs. Section's bold title) still marks where
      // the installments table starts.
      return React.createElement(
        "div",
        { style: { marginTop: 24 } },
        React.createElement(
            ...
            React.createElement(
              ...
              rows.length > 1 &&
                React.createElement(
                  ...
                  `Total: ${percentageSum}%${percentageOverLimit ? " — exceeds 100%, please adjust" : ""}`,
                ),
            ),
            AntButton
              ? React.createElement(
                ...
                return React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(TextArea, {
                      ...
                      placeholder: "e.g. 50% upon signing",
                      rows: 2,
                    }),
                  ),
                  React.createElement(
    ...
    const ContractCreateForm = () => {
      ...
      const paymentScheduleServiceOptions = useMemo(
        () => [
          ...selectedContractServiceLines.map((line) => ({
            value: lineKey(line),
            label: line.serviceName || `Service #${lineKey(line)}`,
          })),
          ...manualServiceRows.map((row) => ({
            value: row.id,
            label: row.serviceName || "Dịch vụ thủ công",
          })),
        ],
      ...
      const applyCombo = async (comboId) => {
        ...
        if (!items.length) {
          message.warning("Combo dịch vụ này chưa có dịch vụ nào.");
          return;
        }
        ...
        const dedupeBaseline = wasPackageMode ? [...manualServiceRows] : [];
        items.forEach((item) => {
          const svc = item.services || {};
        ...
        if (skippedDuplicateNames.length) {
          message.warning(`Đã bỏ qua ${skippedDuplicateNames.length} dịch vụ đã có trên hợp đồng: ${skippedDuplicateNames.join(", ")}`);
        }
        ...
        setManualServiceRows((prev) => [...(wasPackageMode ? prev : foldedExistingRows), ...newRowsWithOwnPricing]);
        const nextSubTotal = (wasPackageMode ? parseNum(form.subTotal || form.fixedAmount) : 0) + comboOwnAmount;
      ...
      const validate = () => {
        ...
        if (form.billingCycle === "multiple_payments") {
          ...
          if (
            ...
            return "Please enter payment percentage for every payment installment.";
          }
          ...
          if (
            ...
            return "Please select at least one service for every payment installment.";
          }
        }
        if (
          isRetainer &&
        ...
        if (manualServiceRows.length) {
          ...
          if (
            ...
            return "Please enter combo subtotal.";
          }
        }
        if (
      ...
      const handleSubmit = async () => {
        ...
        try {
          ...
          // "Total amount" is now a plain, always-editable field (2026-09-22
          // — Fee Model removed) that syncManualLineTotals() already keeps
          // auto-filled from the selected services' sum, but a lawyer typing
          // over it by hand must win — headerTotals.totalAmount (recomputed
          // fresh from the current service rows) is only the fallback for
          // when nothing was ever typed/selected (e.g. a Retainer with no
          // itemized services at all).
          const resolvedTotalAmount =
            parseNum(form.totalAmount) || headerTotals.totalAmount || 0;
          ...
          if (contractId && isByCase && paymentSchedulePayload?.installments?.length) {
            for (const installment of paymentSchedulePayload.installments) {
              try {
                ...
                const scheduleRowId = extractId(
                  scheduleRes?.data?.data?.id || scheduleRes?.data?.id,
                );
                ...
                message.warning(
                  `Could not create payment schedule installment "${installment.label}" — its Payment Request was not auto-created. You can add it manually from the contract's Payment Schedule tab.`,
                );
              }
            }
          }
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Field,
                  { label: "Payment mode", required: true },
                ...
                !isRetainer &&
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        Field,
                        { label: "Total amount", required: true },
                        React.createElement(MoneyInput, {
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            ...
                            nextPaymentDate
                              ...
                              : "Auto calculated after first payment and duration",
                          ),
                        ),
                    ),
                  ),
                  ...
                  // Rendered immediately after Services (not after Commercial
                  // Terms/Contract Date as before) so the merged "Services &
                  // Payment" block (§ layout revision, 2026-09-21) reads as one
                  // continuous flow — see PaymentScheduleSection's own comment
                  // on why it no longer wraps itself in its own Section.
                  showPaymentSchedule &&
