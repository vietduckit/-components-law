              ...
              React.createElement(
                ...
                [
                  packageCatalogTotal > 0
                    ? `Giá catalog gốc: ${formatMoneyByCurrency(packageCatalogTotal, baseCurrency)}`
                    : null,
                  comboConversionNote
...
const QuotationCreateForm = () => {
  ...
  const applyCombo = async (comboId) => {
    ...
    // Combo pricing on the Quotation is always VND — the manual Currency
    ...
    setPackageField("packageSubTotal", convertedSubTotal);
