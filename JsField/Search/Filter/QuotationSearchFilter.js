  ...
  filters: [
    ...
    },
    {
      ...
      source: {
        ...
        sort: 'createdAt',
        // Only customers that at least one quotation points to via
        // customerId — same-name customers with no quotation stay out of
        // the dropdown so they can't be picked by mistake.
